...
var rest = document.querySelector("#select #rest")
var dish = document.querySelector("#select #dish")

rest.addEventListener("click",function(){
    document.querySelector("#asian").style.display ="none";
    document.querySelector("#feat_rest").style.display ="initial";
    document.querySelector("#rest").style.boxShadow ="1px 1px 3px 3px rgb(254, 137, 116)";
    document.querySelector("#dish").style.boxShadow ="none"
})

dish.addEventListener("click",function(){
    document.querySelector("#asian").style.display ="initial";
    document.querySelector("#feat_rest").style.display ="none";
    document.querySelector("#dish").style.boxShadow ="1px 1px 3px 3px rgb(116, 199, 254)";
    document.querySelector("#rest").style.boxShadow ="none"
})
